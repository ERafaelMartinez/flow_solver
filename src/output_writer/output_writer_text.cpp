...
void OutputWriterText::writeFile(double currentTime)
{
  ...
  // write mesh width
  file << "nCells: " << discretization_->gridSize()[0] << "x" << discretization_->gridSize()[1]
       << ", dx: " << discretization_->cellSize()[0] << ", dy: " << discretization_->cellSize()[1] << std::endl
       << std::endl;
  ...
  for (int j = discretization_->uJEnd() - 1; j >= discretization_->uJBegin(); j--)
  {
    ...
    for (int i = discretization_->uIBegin(); i < discretization_->uIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->u().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
  ...
  for (int j = discretization_->vJEnd() - 1; j >= discretization_->vJBegin(); j--)
  {
    ...
    for (int i = discretization_->vIBegin(); i < discretization_->vIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->v().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
  ...
  for (int j = discretization_->pJEnd() - 1; j >= discretization_->pJBegin(); j--)
  {
    ...
    for (int i = discretization_->pIBegin(); i < discretization_->pIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->p().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
  ...
  for (int j = discretization_->uJEnd() - 1; j >= discretization_->uJBegin(); j--)
  {
    ...
    for (int i = discretization_->uIBegin(); i < discretization_->uIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->f().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
  ...
  for (int j = discretization_->vJEnd() - 1; j >= discretization_->vJBegin(); j--)
  {
    ...
    for (int i = discretization_->vIBegin(); i < discretization_->vIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->g().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
  ...
  for (int j = discretization_->pJEnd() - 1; j >= discretization_->pJBegin(); j--)
  {
    ...
    for (int i = discretization_->pIBegin(); i < discretization_->pIEnd(); i++)
    {
      file << std::setw(fieldWidth) << std::setprecision(fieldWidth - 6) << discretization_->rhs().at(i, j);
    }
    file << std::endl;
  }
  file << std::endl;
